...
screen 1 do
#   top    [ :views, :title, :spacer, :keychain, :spacer, :tray, :uptime, :memory, :cpu, :loadavg, :clock ]
  top    [ :views, :spacer, :tray, :uptime, :memory, :cpu, :loadavg, :clock ]
#  bottom [ ]
end
...
# Style for all style elements - the taskbars
style :all do
  background  "#202020"
  icon        "#757575"
  border      "#565656", 0
  padding     0, 8
  #font        "-*-*-*-*-*-*-14-*-*-*-*-*-*-*"
  font        "xft:Blockzone:style=regular:size=11:antialias=true:hintstyle=slightrestart"
end
...
# Jump to view1, view2, ... same as jump to view
...
# Move mouse to screen1, screen2, ... for multi screen
...
grab "Menu", "thunar"
grab "W-C-l", "geany"
grab "XF86AudioRaiseVolume", "amixer -q sset Master 5%+ unmute" 
grab "XF86AudioLowerVolume", "amixer -q sset Master 5%- unmute"
grab "XF86AudioMute", "amixer sset Master,0 toggle"
grab "C-W-g", "gimp"
grab "C-W-p", "libreoffice --calc"
grab "C-W-o", "libreoffice --writer"
...
tag "FXapps" do
     match "xfontsel|xcalc|galculator|gcolor2"
     float true
     # stick true
end

tag "MediaApps" do
     match "audacious|vlc|smplayer|mpv"
     stick false
     resize true
     gravity :NoTileX
end
...
view "1",  "default|terms|editor|FXapps|DevApps"
view "2",  "browser|mail|web"
view "3",  "gimp_.*"
view "4",  "MediaApps|media"
