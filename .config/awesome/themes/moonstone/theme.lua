...
-- {{{ Styles
theme.font      = "SF Display Regular 10"
...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = themes_path .. "moonstone/taglist/squarefz.png"
theme.taglist_squares_unsel = themes_path .. "moonstone/taglist/squarez.png"
