...
-- vicious.register(cpu, vicious.widgets.cpu, "CPU: $1% 1: $2% 2: $3% 3: $4% 4: $5%", 2)
...
vicious.register(wifi, vicious.widgets.wifi, "${rate}MB/s ${link}%", 3, "wlo1")
-- End Wifi }}}
...
vicious.register(netwidget, vicious.widgets.net, '<span color="#C9C9C9">   ${enp2s0 down_mb} mB/s</span> <span color="#C9C9C9">  ${enp2s0 up_mb} mB/s</span><span color="#C9C9C9"> </span>', 3)
-- End network widget